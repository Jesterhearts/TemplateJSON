...
namespace tjson {
    ...
    namespace iterables {
        ...
        template<typename... T, template<typename... T> class Container, typename store_tag>
        inline void from_json(Tokenizer& tokenizer, DataMember<Container<T...>, store_tag>& into) {
    ...
    template<typename T, std::size_t A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::array<T, A>, store_tag>& into) {
    ...
    template<typename T, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::deque<T, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename T, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::forward_list<T, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename T, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::list<T, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename T, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::vector<T, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename K, typename C, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::set<K, C, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename K, typename C, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::multiset<K, C, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename K, typename H, typename KE, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::unordered_set<K, H, KE, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
    ...
    template<typename K, typename T, typename C, typename A, typename store_tag>
    inline void from_json(detail::Tokenizer& tokenizer, detail::DataMember<std::map<K, T, C, A>, store_tag>& into) {
        return detail::iterables::from_json(tokenizer, into);
    }
}
#endif
